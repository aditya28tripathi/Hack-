...
const Header4 = () => {
  ...
  <div className="relative">
    <input type="email" className="px-6 py-3 rounded-lg mr-5 w-80 h-16 outline-none border border-gray-300" placeholder="e.g. xyxyxyxy@gmail.com"/>
    <span className="absolute top-0 left-3 transform -translate-y-1/2 px-3 bg-white text-gray-500">Your Email</span>
  </div>
